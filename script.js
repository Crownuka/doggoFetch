const RANDOM_IMG_ENDPOINT = "https://dog.ceo/api/breeds/image/random";
    ...
    if (e.target.value === correctAnswer) {
        ...
        const correctButton =
            document.querySelector(`button[value="${correctAnswer}"]`);
        correctButton.classList.add("correct");
        alert(`Hint: The correct breed is "${correctAnswer}"`);
    }
    renderNextButton();
}
    ...
    nextBtn.textContent = "Next Dog";
    nextBtn.addEventListener("click", startGame);
    container.replaceChildren(nextBtn);
}
   ...
   async function startGame() {
    ...
    document.getElementById("next-container").replaceChildren();
